...
export default function StudentServicesDashboard() {
  ...
  return (
    <>
    {/* <Navbar /> */}
    <section className="min-h-screen w-full relative py-8 sm:py-12 md:py-12 lg:py-12 flex items-center justify-center overflow-hidden bg-gradient-to-b from-white via-blue-50 to-indigo-100">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10 w-full">
        ...
        >
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-6 sm:mt-8 md:mt-10 font-bold bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 bg-clip-text text-transparent">
              CD Smart Campus
            </h2>
          </motion.div>
        </motion.div>
